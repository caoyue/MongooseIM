...
-module(cyrsasl_scram_aft).

-author('stephen.roettger@googlemail.com').

-export([start/1, stop/0, mech_new/5, mech_step/2]).
...
mech_new(_Host, GetInfo, GetPassword, _CheckPassword,
         _CheckPasswordDigest) ->
    {ok, #state{step = 2, get_info_by_loginname = GetInfo, get_password = GetPassword}}.
